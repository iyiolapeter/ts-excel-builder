...
class DocPropsApp extends Xmler {
  public toxml() {
    const props = xml.create("Properties", {
      version: "1.0",
      encoding: "UTF-8",
      standalone: true
    });
...
class Style extends Xmler {
  ...
  public toxml() {
    const ss = xml.create("styleSheet", {
      version: "1.0",
      encoding: "UTF-8",
      standalone: true
    });
    ...
    for (const o of this.mfills) {
      ...
      if (o.fgColor !== "-") {
        es.ele("fgColor", { theme: "8", tint: "0.79998168889431442" });
      }
      if (o.bgColor !== "-") {
    ...
    ss.ele("cellStyleXfs", { count: "1" })
      .ele("xf", { numFmtId: "0", fontId: "0", fillId: "0", borderId: "0" })
